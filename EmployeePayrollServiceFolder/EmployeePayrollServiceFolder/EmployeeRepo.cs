...
namespace EmployeePayrollServiceProgram
{
    class EmployeeRepo
    {
        public static string connectionString = @"Data Source= DESKTOP-RA9N9FA\SQLEXPRESS; Initial Catalog=payroll_service_db;Integrated Security=True";
        ...
        public void GetAllEmployee()
        {
            try
            {
                ...
                {
                    string query = @"Select * from employee_payroll_database;";
